...
class ArmMoveIt:
    ...
    def execute_joint_trajectory(self, joint_traj, use_custom_time=False, group_id=0):
        ...
        #    plan.joint_trajectory.points[i].positions = self._simplify_joints(pt.positions)
        
        # execute
        self.move_robot(plan, group_id)

    # ee_traj is PoseStamped list
    def execute_ee_trajectory(self, ee_traj, use_custom_time=False, group_id=0):
    ...
    '''
    def _nearest_equivalent_angle(self, desired, current):
    ...
    def plan_targetInputWaypoint(self, targets, joint_flag, merged=False, 
        ...
        print 'plan_targetInputWaypoint'
